...
public class ReportBuilder {
  ...
  private static final Font SUB_HEADING_GRAY_FONT = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, BaseColor.DARK_GRAY);
  ...
  public ReportBuilder withHeader(FairSolution solution) throws DocumentException, IOException, URISyntaxException {
    Paragraph reportHeader = new Paragraph();
    reportHeader.add(new Paragraph("Personalized FAIRification process report", TITLE_FONT));
    reportHeader.add(new Paragraph("Title: " + solution.title, SUB_HEADING_GRAY_FONT));
    reportHeader.add(new Paragraph("Project: " + solution.project, SUB_HEADING_GRAY_FONT));
    reportHeader.add(new Paragraph("Generated by: FAIR Wizard on " + new Date(), SUB_HEADING_GRAY_FONT));
    addEmptyLine(reportHeader, 1);
    reportHeader.add(new Paragraph(solution.description, PARAGRAPH_FONT_GRAY));
  ...
  public ReportBuilder withFooter(FairSolution solution) throws DocumentException {
    ...
    reportFooter.add(new Paragraph("Comments", HEADING_FONT));
    reportFooter.add(new Paragraph(solution.comments, PARAGRAPH_FONT));

    addEmptyLine(reportFooter, 1);
    reportFooter.add(new Chunk("For more information please check ", PARAGRAPH_FONT));
    reportFooter.add(new Chunk("FAIR Wizard.", PARAGRAPH_FONT_BLUE).setAnchor(solution.getLink()));
    reportFooter.add(new Chunk(" To view an interactive web version of this report, please visit ", PARAGRAPH_FONT));
    reportFooter.add(new Chunk("here.", PARAGRAPH_FONT_BLUE).setAnchor(solution.getLink()));
    reportFooter.add(
      new Chunk(" If you have any questions or have any comments, please provide feedback ", PARAGRAPH_FONT));
    reportFooter.add(
      new Chunk("here.", PARAGRAPH_FONT_BLUE).setAnchor("https://github.com/FAIRplus/FAIR_wizard/issues/new?title=Re: "
                                                        + solution.getLink() + "&body=Please include report link with your issue. <br/> "
                                                        + solution.getLink() + " <br/> "));
    document.add(reportFooter);
